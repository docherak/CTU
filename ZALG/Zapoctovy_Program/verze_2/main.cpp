...
int main() {
	...
	Vstupni soubor s pevnym nazvem vstup.txt je nutne dat do stejne slozky jako program
	a pro spravne fungovani musi byt obsah v nasledujicim formatu:
	...
	Program vykresli cely proces hledani cile (vsechny pozice agenta 'a') a nasledne
	zobrazi pouze finalni optimalni trasu (oznacena pomoci 'O').
